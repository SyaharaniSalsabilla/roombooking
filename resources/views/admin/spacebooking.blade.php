            ...
            <div class="card">
                <div class="card-body">
                    <div class="product-slider owl-carousel owl-theme" id="sync1">
                        <div class="item"><img src="/assets/front/image/Sangita/Sangita.jpg" alt=""></div>
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="m-t-15 btn-showcase">
                        <a class="btn btn-primary" href="cart.html" title=""> 
                            <i class="fa fa-shopping-basket me-1"></i>Add To Cart
                        </a>
                        <a class="btn btn-success" href="checkout.html" title=""> 
                            <i class="fa fa-shopping-cart me-1"></i>Buy Now
                        </a>
                        <a class="btn btn-secondary" href="list-wish.html"> 
