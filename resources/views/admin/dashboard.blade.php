                        ...
                        <tbody>
                            @foreach($customers as $cust)
                                <tr>
                                    ...
                                    <td class="img-content-box"><a class="f-w-500">{{$cust->profile->nama}}</a>
                                    <span class="f-light">{{$cust->profile->email}}</span></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                                    ...
                                    <table class="table"> 
                                        ...
                                        <tbody> 
                                            @foreach($this_week_orders as $orders)
                                                <tr> 
                                                    <td class="f-w-500">{{$orders->ruangan->nama_ruangan}}</td>
                                                    <td class="f-w-500">{{$orders->profile->nama}}</td>
