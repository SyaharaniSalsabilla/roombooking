...
<body class="min-h-screen flex items-center justify-center bg-primary-2">
    <div class="w-full max-w-md p-6 space-y-2">
        ...
        @csrf
            <div class="flex flex-col"><span>{{ $errors->has('message') ? $errors->first('message') : ''}}</span></div>
            ...
            <button class="mt-4 w-full bg-primary-5 text-primary-2 py-3 px-4 rounded-md font-medium hover:bg-red-700 transition-colors">
                Kirim</button>
        </form>
    </div>
</body>
