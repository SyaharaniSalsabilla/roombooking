<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="../assets/images/logo/Anindhaloka.png" alt=""></a></div>
        ...
        <ul class="nav-menus">
            ...
            <div class="media profile-media"><img class="b-r-10" src="../assets/images/dashboard/profile.png" alt="">
                <div class="media-body"><span>Admin NinSpace</span>
